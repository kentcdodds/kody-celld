...
| MCP auth for clients                           | OAuth 2.1 authorization server: RFC 8414/9728 discovery, DCR, PKCE S256, refresh rotation + replay detection, RFC 7009 ([mcp-oauth.md](./mcp-oauth.md))                                     | — (static `kc_…` tokens still accepted)                                                                                    | **Built-in**, smoke-tested     |
